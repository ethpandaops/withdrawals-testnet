...
terraform {
  backend "s3" {
    ...
    key                         = "infrastructure/withdrawal-mainnet-shadowfork-3/terraform.tfstate"
  }
}
////////////////////////////////////////////////////////////////////////////////////////
//                                        VARIABLES
...
variable "ethereum_network" {
  type = string
  default = "withdrawal-mainnet-shadowfork-3"
}
...
variable "digitalocean_vpcs" {
  ...
  default = {
    "ams3" = {
      name = "withdrawal-mainnet-shadowfork-3-ams"
      ip_range = "10.100.75.0/24"
    },
    "nyc3" = {
      name = "withdrawal-mainnet-shadowfork-3-nyc3"
      ip_range = "10.100.76.0/24"
    },
    "tor1" = {
      name = "withdrawal-mainnet-shadowfork-1-tor1"
      ip_range = "10.100.77.0/24"
    },
    "blr1" = {
      name = "withdrawal-mainnet-shadowfork-3-blr1"
